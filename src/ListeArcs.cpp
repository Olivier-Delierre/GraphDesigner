...
ListeArcs::ListeArcs() : d_racine{nullptr}
{}

void ListeArcs::ajouter(ChainonArc *chainearc)
{
	/*ChainonArc *courant = d_suivant;
...
void ListeArcs::supprimer(ChainonArc *chainearc)
{
	/*if (this != nullptr) {
